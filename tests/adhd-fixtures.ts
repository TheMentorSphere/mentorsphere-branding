export function validAdhdRequest(supportFor = "adult"): Record<string, unknown> {
    return {
        ...
        child: { name: ["child", "combined"].includes(supportFor) ? "Sam Example" : "", educationalStage: ["child", "combined"].includes(supportFor) ? "Years 7 to 9 / KS3" : "", educationalStageOther: "", neurodivergence: [], neurodivergenceOther: "", difficulties: [], difficultiesOther: "" },
