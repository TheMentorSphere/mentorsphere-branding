...
async function secondary() {
  ...
  await named(page, 'exam_board_maths').fill('Not applicable');
  ...
  await named(page, 'exam_board_maths').fill('Not known');
  await choice(page, 'learner_subjects', 'Science');
  await named(page, 'exam_board_science').fill('Fictional removed board');
